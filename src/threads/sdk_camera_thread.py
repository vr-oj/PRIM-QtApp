...
class SDKCameraThread(QThread):
    ...
    def __init__(
        ...
        # user-requested parameters (for compatibility)
        self.device_info = device_info
        self.target_fps = target_fps
        self.desired_width = desired_width
        self.desired_height = desired_height
        self.desired_pixel_format = desired_pixel_format
        ...
        # ensure backward compatibility: ignore desired_* fields if unused
        # pixel format will be populated from GenICam enumeration
