    ...
    def run(self):
        ...
        try:
            ...
            try:
                ...
                log.warning(f"Streaming setup failed, falling back to snap: {e}")
            ...
            while True:
                ...
                # Acquire frame via SnapSink with integer timeout
                result = sink.snap_single(1000)
                if result.is_ok:
                    img = result.image
